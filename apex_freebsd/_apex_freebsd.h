...
//
//   //CLASS_DECL_APEX_FREEBSD bool        shell_get_special_folder_path(HWND hwnd, ::file::path& str, i32 csidl, bool fCreate);
...
//
//   ////CLASS_DECL_APEX_FREEBSD ::file::path get_known_folder(REFKNOWNFOLDERID kfid);
//
//} // namespace freebsd
